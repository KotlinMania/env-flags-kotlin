...
kotlin {
    ...
    val xcf = XCFramework("EnvFlags")

    macosArm64 {
        binaries.framework { baseName = "EnvFlags"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "EnvFlags"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "EnvFlags"
        flattenPackage = "io.github.kotlinmania.envflags"
    }

    android {
        namespace = "io.github.kotlinmania.envflags"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "env-flags-kotlin", version.toString())

    pom {
        name.set("env-flags-kotlin")
        description.set("Kotlin Multiplatform port of kykosic/env-flags - A convenience macro for declaring environment variables")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/env-flags-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/env-flags-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/env-flags-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/env-flags-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.envflags.codeql
