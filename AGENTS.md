...
This file is the quick-reference operating contract for env-flags-kotlin. The longer
...
env-flags-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`env-flags`](https://crates.io/crates/env-flags). Upstream Rust is the behavioral oracle while the
